...
void setup() {
  ...
  mySwitch.enableTransmit(GPIO_NUM_19); // Transmitter is connected to ESP32 GPIO 19
  mySwitch.enableReceive(GPIO_NUM_15);  // RF Receiver is connected to ESP32 GPIO 15
